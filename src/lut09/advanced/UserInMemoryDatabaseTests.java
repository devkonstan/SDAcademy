...
public class UserInMemoryDatabaseTests {
    ...
    public void addingUserShouldNotIncrementNumOfUsers() {
        ...
        // Then
        assertNotEquals(2, users.getUsersCount()); //to sie nie spelni po dodaniu 1 uzytkownika
        assertFalse(users.getUsersCount() != 1); //to rowniez, gdyz liczba bedzie wynosila 1
    }
